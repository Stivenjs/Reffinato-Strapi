...
export interface ApiCartItemCartItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Item in a user's shopping cart";
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    colors: Schema.Attribute.Component<'color.color-attribute', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    sizes: Schema.Attribute.Component<'size.size-attribute', true> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPromotionCodePromotionCode
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discountPercentage: Schema.Attribute.Decimal & Schema.Attribute.Required;
    isActive: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    users: Schema.Attribute.Relation<'manyToMany', 'api::auth.auth'>;
    validFrom: Schema.Attribute.Date;
    validUntil: Schema.Attribute.Date;
  };
}

export interface ApiSeasonalPromotionSeasonalPromotion
  extends Struct.CollectionTypeSchema {
  collectionName: 'seasonal_promotions';
  info: {
    description: '';
    displayName: 'Seasonal Promotion';
    pluralName: 'seasonal-promotions';
    singularName: 'seasonal-promotion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::seasonal-promotion.seasonal-promotion'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiSocialShopSocialShop extends Struct.CollectionTypeSchema {
  collectionName: 'social_shops';
  info: {
    displayName: 'Social Shop';
    pluralName: 'social-shops';
    singularName: 'social-shop';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    username: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'REFFINATO'>;
  };
}
...
export interface ApiVideoVideo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::video.video'> &
      Schema.Attribute.Private;
    phrase: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::social-shop.social-shop': ApiSocialShopSocialShop;
